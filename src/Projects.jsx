    ...
    <section className="px-4" id="work">
      ...
      <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 scrollbar-none -mx-4 px-4">
        {projects.map((project, i) => (
          <EachProject key={project.title} project={project} delay={i * 150} />
        ))}
      </div>
